...
from .tts_views import TriggerTTSView, BatchTTSStatusView, BatchTriggerTTSView
...
urlpatterns = [
    ...
    path('tts/batch-status/', BatchTTSStatusView.as_view(), name='batch_tts_status'),
    path('tts/batch-trigger/', BatchTriggerTTSView.as_view(), name='batch_tts_trigger'),
]
